...
public class CaptchaServlet extends HttpServlet{
	...
	public void init(ServletConfig servletconfig) throws ServletException {
        ...
        captchaService = BeanFactoryUtils.beanOfTypeIncludingAncestors(webapplicationcontext, MultiTypeCaptchaService.class);
        session = BeanFactoryUtils.beanOfTypeIncludingAncestors(webapplicationcontext,SessionProvider.class);
    }
