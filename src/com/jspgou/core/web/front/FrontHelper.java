...
public abstract class FrontHelper{
    ...
    public static String pageNotFound(Website website, ModelMap modelmap, 
        ...
        return website.getTplSys("common", MessageResolver.getMessage(request, TPL_PAGE_NOT_FOUND, new Object[0]),request);
    }
    ...
    public static String showSuccess(String s, String s1, Website website, 
        ...
        return website.getTplSys("common", MessageResolver.getMessage(request, TPL_SUCCESS_PAGE, new Object[0]),request);
    }
	...
	public static String showError(WebErrors weberrors, Website website, 
        ...
        return website.getTplSys("common", MessageResolver.getMessage(request,TPL_ERROR_PAGE, new Object[0]),request);
    }
    ...
    public static String showMessage(String s, Website website,
        ...
        setCommonData(request, modelmap, website, 1);
        modelmap.addAttribute("message", s);
        return website.getTplSys("common", MessageResolver.getMessage(request, TPL_MESSAGE_PAGE, new Object[0]),request);
    }
