...
public abstract class BaseShopPlug  implements Serializable {
	 ...
	 */
	public BaseShopPlug (java.lang.Long id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.jspgou.cms.entity.ShopPlug)) return false;
		else {
			com.jspgou.cms.entity.ShopPlug shopPlug = (com.jspgou.cms.entity.ShopPlug) obj;
			if (null == this.getId() || null == shopPlug.getId()) return false;
			else return (this.getId().equals(shopPlug.getId()));
		}
	}
