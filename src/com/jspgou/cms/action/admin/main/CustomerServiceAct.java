...
public class CustomerServiceAct {
	...
	public String list(Integer pageNo, HttpServletRequest request,
		...
		Pagination pagination = manager.getPagination(null,cpn(pageNo), CookieUtils
				.getPageSize(request));
	...
	public String edit(Long id, Integer pageNo, HttpServletRequest request, ModelMap model) {
		...
		model.addAttribute("customerService", manager.findById(id));
		model.addAttribute("pageNo", pageNo);
	...
	public String qqDelete(Long[] ids, Integer pageNo, HttpServletRequest request,
		...
		CustomerService[] beans=manager.deleteByIds(ids);
	...
	private boolean vldExist(Long id, Long webId, WebErrors errors) {
		...
		CustomerService entity = manager.findById(id);
