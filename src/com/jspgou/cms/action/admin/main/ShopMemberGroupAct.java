...
public class ShopMemberGroupAct {
	...
	public String list(Integer pageNo, HttpServletRequest request,
			ModelMap model) {
		List<ShopMemberGroup> list = manager.getList(com.jspgou.core.web.SiteUtils
				.getWebId(request));
	...
	public String delete(Long[] ids, Integer pageNo,
		...
		try{
			...
			errors.addErrorString(productMng.getTipFile("Please.delete.the.member.then.delete.the.operation"));
			return errors.showErrorPage(model);	
		}
		return list(pageNo, request, model);
	}
