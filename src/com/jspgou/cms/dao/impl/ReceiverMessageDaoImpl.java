...
@Repository
public class ReceiverMessageDaoImpl extends HibernateBaseDao<ReceiverMessage, Long> implements ReceiverMessageDao {
	...
	public Pagination getUnreadPage(Long sendMemberId, int pageNo, int pageSize) {
		...
		/*[选取未读过的收件]*/
		finder.append(" and msg.msgStatus=:unread").setParam("unread", false);
		finder.append(" order by msg.id desc");
		return find(finder, pageNo, pageSize);
	}

	public ReceiverMessage findById(Long id) {
		ReceiverMessage entity = get(id);
		return entity;
	}
