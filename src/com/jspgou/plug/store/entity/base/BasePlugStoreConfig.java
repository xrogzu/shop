...
public abstract class BasePlugStoreConfig  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.jspgou.plug.store.entity.PlugStoreConfig)) return false;
		else {
			com.jspgou.plug.store.entity.PlugStoreConfig plugStoreConfig = (com.jspgou.plug.store.entity.PlugStoreConfig) obj;
