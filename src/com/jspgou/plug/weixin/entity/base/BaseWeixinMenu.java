...
public abstract class BaseWeixinMenu  implements Serializable {
	...
	// many to one
	private com.jspgou.plug.weixin.entity.WeixinMenu parent;
	private com.jspgou.core.entity.Website site;

	// collections
	private java.util.Set<com.jspgou.plug.weixin.entity.WeixinMenu> child;
	 ...
	 */
	public com.jspgou.plug.weixin.entity.WeixinMenu getParent () {
		return parent;
	}
	 ...
	 */
	public void setParent (com.jspgou.plug.weixin.entity.WeixinMenu parent) {
		this.parent = parent;
	}
	 ...
	 */
	public java.util.Set<com.jspgou.plug.weixin.entity.WeixinMenu> getChild () {
		return child;
	}
	 ...
	 */
	public void setChild (java.util.Set<com.jspgou.plug.weixin.entity.WeixinMenu> child) {
		this.child = child;
	}

	public void addTochild (com.jspgou.plug.weixin.entity.WeixinMenu weixinMenu) {
		if (null == getChild()) setChild(new java.util.TreeSet<com.jspgou.plug.weixin.entity.WeixinMenu>());
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.jspgou.plug.weixin.entity.WeixinMenu)) return false;
		else {
			com.jspgou.plug.weixin.entity.WeixinMenu weixinMenu = (com.jspgou.plug.weixin.entity.WeixinMenu) obj;
