...
public class MessageAct {
	...
	public void weixin(String signature,String timestamp,String nonce,String echostr,
		...
		String token = weixinMng.find(site.getId()).getToken();
	...
	private String processRequest(String echostr,HttpServletRequest request,HttpServletResponse response) throws IOException{
        ...
        String fromUsername = root.elementText("FromUserName");  //取得发送者 // 发送方帐号（open_id）
        String toUsername = root.elementText("ToUserName");  //取得接收者     // 公众帐号  
        ...
        String welcome=weixinMng.find(SiteUtils.getWebId(request)).getWelcome();
